...
module.exports = (obj) => {
  ...
  fs.writeFileSync(`./${appName}/imports/startup/client/routes.js`, routes());
    ...
    routes.map((route) => {
      ...
      if (route.childRoutes) {
        fs.writeFileSync(
          ...
          component(route.name, route.component, route.subComponents)
        );
        if (route.wrapChildRoutes) {
          renderRoutes(route.childRoutes, route.name);
        } else {
